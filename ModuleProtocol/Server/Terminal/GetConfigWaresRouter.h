...
{
    /** 心跳 */
    class MODULE_PROTOCOL_API GetConfigWaresRouter : public Router
    {
        Q_OBJECT
    public:
        GetConfigWaresRouter() = default;
        virtual ~GetConfigWaresRouter() = default;
    ...
    using GetConfigWaresRouterPtr = QSharedPointer<GetConfigWaresRouter>;
}