...
{
    /** 修改配置商品 */
    class MODULE_PROTOCOL_API ModifyStockOrderRouter : public Router
    {
        Q_OBJECT
    public:
        ModifyStockOrderRouter() = default;
        virtual ~ModifyStockOrderRouter() = default;
    ...
    using ModifyStockOrderRouterPtr = QSharedPointer<ModifyStockOrderRouter>;
}