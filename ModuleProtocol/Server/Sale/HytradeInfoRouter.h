...
{
    /** 出库订单结算 */
    class MODULE_PROTOCOL_API HytradeInfoRouter : public Router
    {
        Q_OBJECT
    public:
        HytradeInfoRouter() = default;
        virtual ~HytradeInfoRouter() = default;
    ...
    using HytradeInfoRouterPtr = QSharedPointer<HytradeInfoRouter>;
}