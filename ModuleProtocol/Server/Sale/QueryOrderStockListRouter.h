...
{
    /** 查询备货清单 */
    class MODULE_PROTOCOL_API QueryOrderStockListRouter : public Router
    {
        Q_OBJECT
    public:
        QueryOrderStockListRouter() = default;
        virtual ~QueryOrderStockListRouter() = default;
    ...
    using QueryOrderStockListRouterPtr = QSharedPointer<QueryOrderStockListRouter>;
}