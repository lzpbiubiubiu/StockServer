...
{
    /** 出库订单结算 */
    class MODULE_PROTOCOL_API QueryOrderReportRouter : public Router
    {
        Q_OBJECT
    public:
        QueryOrderReportRouter() = default;
        virtual ~QueryOrderReportRouter() = default;
    ...
    using QueryOrderReportRouterPtr = QSharedPointer<QueryOrderReportRouter>;
}