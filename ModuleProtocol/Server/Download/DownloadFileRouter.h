...
{
    /** 下载文件 */
    class MODULE_PROTOCOL_API DownloadFileRouter : public Router
    {
    public:
        DownloadFileRouter() = default;
        virtual ~DownloadFileRouter() = default;
    ...
    using DownloadFileRouterPtr = QSharedPointer<DownloadFileRouter>;
}